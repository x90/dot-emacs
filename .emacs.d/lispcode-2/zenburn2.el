...
(defvar zenburn-true-yellow "#ffff00")
  ...
  (color-theme-install
   (append
    (list 'color-theme-zenburn
     ...
     `(zenburn-paren-cols 
       ((t (:foreground ,zenburn-true-yellow :weight bold))))
     `(zenburn-paren-settings
       ((t (:inherit zenburn-paren-cols))))
     '(show-paren-match ((t (:inherit zenburn-paren-settings))))
     ...
     `(cursor ((bar (:background ,zenburn-true-yellow 
				 :foreground ,zenburn-true-yellow))))
