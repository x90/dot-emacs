...
(put 'emacspeak-speak 'custom-loads '(emacspeak-speak emacspeak-wizards emacspeak-advice))
...
(put 'emacspeak-piglets 'custom-loads '(emacspeak-piglets))
...
(put 'applications 'custom-loads '(emacspeak))
(put 'emacspeak-midge 'custom-loads '(emacspeak-midge))
(put 'emacspeak-madplay 'custom-loads '(emacspeak-madplay))
...
(put 'emacspeak-atom 'custom-loads '(emacspeak-webutils))
(put 'emacspeak-xsl 'custom-loads '(emacspeak-webutils))
...
(put 'emacspeak-webmarks 'custom-loads '(emacspeak-webmarks))
(put 'emacspeak-alsaplayer 'custom-loads '(emacspeak-alsaplayer))
