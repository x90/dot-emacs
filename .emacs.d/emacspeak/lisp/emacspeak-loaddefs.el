;;;Auto generated

;;;### (autoloads (cd-tool) "cd-tool" "cd-tool.el" (19011 5631))
...
;;;;;;  "dtk-speak" "dtk-speak.el" (19011 5631))
...
(custom-autoload (quote tts-strip-octals) "dtk-speak" t)
...
(custom-autoload (quote dtk-stop-immediately-while-typing) "dtk-speak" t)

(defvar dtk-speech-rate-base 50 "\
*Value of lowest tolerable speech rate.")

(custom-autoload (quote dtk-speech-rate-base) "dtk-speak" t)
...
(custom-autoload (quote dtk-speech-rate-step) "dtk-speak" t)
...
(custom-autoload (quote dtk-startup-hook) "dtk-speak" t)
...
(custom-autoload (quote dtk-cleanup-patterns) "dtk-speak" t)

(defvar dtk-use-tones t "\
Allow tones to be turned off.")

(custom-autoload (quote dtk-use-tones) "dtk-speak" t)
...
(custom-autoload (quote dtk-speak-nonprinting-chars) "dtk-speak" t)
...
(custom-autoload (quote dtk-resume-should-toggle) "dtk-speak" t)
...
(custom-autoload (quote emacspeak-media-player) "emacspeak" t)
...
(custom-autoload (quote emacspeak-play-emacspeak-startup-icon) "emacspeak" t)
...
(custom-autoload (quote emacspeak-unibyte) "emacspeak" t)

(autoload (quote emacspeak) "emacspeak" "\
...
;;;;;;  "emacspeak-advice" "emacspeak-advice.el" (19011 5631))
...
(custom-autoload (quote emacspeak-speak-messages-pause) "emacspeak-advice" t)

(defvar emacspeak-speak-cue-errors t "\
Specifies if error messages are cued.")

(custom-autoload (quote emacspeak-speak-cue-errors) "emacspeak-advice" t)

;;;***

;;;### (autoloads (emacspeak-alsaplayer-amark-jump emacspeak-alsaplayer-amark-add
;;;;;;  emacspeak-alsaplayer-cd emacspeak-alsaplayer-find-and-add-to-queue
...
;;;;;;  "emacspeak-alsaplayer" "emacspeak-alsaplayer.el" (19011 5631))
...
(custom-autoload (quote emacspeak-alsaplayer-auditory-feedback) "emacspeak-alsaplayer" t)

(defvar emacspeak-alsaplayer-program "alsaplayer" "\
Alsaplayer executable.")

(custom-autoload (quote emacspeak-alsaplayer-program) "emacspeak-alsaplayer" t)

(defvar emacspeak-alsaplayer-media-directory (expand-file-name "~/mp3/") "\
Directory to look for media files.")

(custom-autoload (quote emacspeak-alsaplayer-media-directory) "emacspeak-alsaplayer" t)
...
(autoload (quote emacspeak-alsaplayer-find-and-add-to-queue) "emacspeak-alsaplayer" "\
Find  specified resource and add to queue.

\(fn PATTERN)" t nil)

(autoload (quote emacspeak-alsaplayer-cd) "emacspeak-alsaplayer" "\
Change default directory, and silence its pronounciation.

\(fn DIRECTORY)" t nil)

(autoload (quote emacspeak-alsaplayer-amark-add) "emacspeak-alsaplayer" "\
...
(autoload (quote emacspeak-alsaplayer-amark-jump) "emacspeak-alsaplayer" "\
...
;;;;;;  "emacspeak-amphetadesk" "emacspeak-amphetadesk.el" (19011
;;;;;;  5631))
...
;;;;;;  "emacspeak-aumix.el" (19011 5631))
;;; Generated autoloads from emacspeak-aumix.el

(let ((loads (get (quote emacspeak-aumix) (quote custom-loads)))) (if (member (quote "emacspeak-aumix") loads) nil (put (quote emacspeak-aumix) (quote custom-loads) (cons (quote "emacspeak-aumix") loads))))
...
(custom-autoload (quote emacspeak-aumix-settings-file) "emacspeak-aumix" t)

(defvar emacspeak-alsactl-program "alsactl" "\
ALSA sound controller used to restore settings.")

(custom-autoload (quote emacspeak-alsactl-program) "emacspeak-aumix" t)
...
(custom-autoload (quote emacspeak-aumix-reset-options) "emacspeak-aumix" t)
...
;;;;;;  "emacspeak-calendar.el" (19011 5631))
...
;;;;;;  "emacspeak-custom" "emacspeak-custom.el" (19011 5631))
...
;;;;;;  "emacspeak-daisy" "emacspeak-daisy.el" (19011 5631))
...
;;;;;;  "emacspeak-eterm.el" (19011 5631))
;;; Generated autoloads from emacspeak-eterm.el

(let ((loads (get (quote emacspeak-eterm) (quote custom-loads)))) (if (member (quote "emacspeak-eterm") loads) nil (put (quote emacspeak-eterm) (quote custom-loads) (cons (quote "emacspeak-eterm") loads))))
...
;;;;;;  "emacspeak-filtertext" "emacspeak-filtertext.el" (19011 5631))
...
(autoload (quote emacspeak-firevox-read-next) "emacspeak-firevox" "\
Read next item on page.

\(fn)" t nil)

(autoload (quote emacspeak-firevox-read-previous) "emacspeak-firevox" "\
Read next item on page.

\(fn)" t nil)

(autoload (quote emacspeak-firevox-read-parent) "emacspeak-firevox" "\
Read parent node.

\(fn)" t nil)

(autoload (quote emacspeak-firevox-websearch) "emacspeak-firevox" "\
Perform Websearch via the Firefox URL bar.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-firevox) "emacspeak-firevox" "\
...
;;;;;;  "emacspeak-fix-interactive.el" (19011 5631))
;;; Generated autoloads from emacspeak-fix-interactive.el

(autoload (quote emacspeak-fix-commands-loaded-from) "emacspeak-fix-interactive" "\
...
;;;;;;  "emacspeak-hide" "emacspeak-hide.el" (19011 5631))
;;; Generated autoloads from emacspeak-hide.el

(autoload (quote emacspeak-hide-all-blocks-in-buffer) "emacspeak-hide" "\
...
;;;;;;  "emacspeak-imenu" "emacspeak-imenu.el" (19011 5631))
;;; Generated autoloads from emacspeak-imenu.el

(autoload (quote emacspeak-imenu-goto-next-index-position) "emacspeak-imenu" "\
Goto the next index position in current buffer

\(fn)" t nil)

(autoload (quote emacspeak-imenu-goto-previous-index-position) "emacspeak-imenu" "\
...
(autoload (quote emacspeak-jawbreaker) "emacspeak-jawbreaker" "\
...
;;;;;;  "emacspeak-keymap" "emacspeak-keymap.el" (19011 5631))
...
(custom-autoload (quote emacspeak-personal-keys) "emacspeak-keymap" nil)
...
(custom-autoload (quote emacspeak-super-keys) "emacspeak-keymap" nil)
...
(custom-autoload (quote emacspeak-alt-keys) "emacspeak-keymap" nil)
...
(custom-autoload (quote emacspeak-hyper-keys) "emacspeak-keymap" nil)
...
;;;;;;  "emacspeak-m-player" "emacspeak-m-player.el" (19011 5631))
;;; Generated autoloads from emacspeak-m-player.el

(let ((loads (get (quote emacspeak-m-player) (quote custom-loads)))) (if (member (quote "emacspeak-m-player") loads) nil (put (quote emacspeak-m-player) (quote custom-loads) (cons (quote "emacspeak-m-player") loads))))
...
(defvar emacspeak-media-extensions (concat (regexp-opt (list ".wma" ".m4a" ".flac" ".ogg" ".mp3" ".MP3" ".mp4") (quote parens)) "$") "\
...
(autoload (quote emacspeak-m-player-volume-up) "emacspeak-m-player" "\
Increase volume.

\(fn)" t nil)

(autoload (quote emacspeak-m-player-volume-down) "emacspeak-m-player" "\
Decrease volume.

\(fn)" t nil)

(autoload (quote emacspeak-m-player-get-length) "emacspeak-m-player" "\
Display length of track in seconds.

\(fn)" t nil)

(autoload (quote emacspeak-m-player-youtube-player) "emacspeak-m-player" "\
...
(autoload (quote emacspeak-moz-eval-expression) "emacspeak-moz" "\
Send expression to Moz.

\(fn EXP)" t nil)

(autoload (quote emacspeak-moz-eval-expression-and-go) "emacspeak-moz" "\
Send expression to Moz and switch to it.

\(fn EXP)" t nil)

(autoload (quote emacspeak-moz-eval-expression-and-browse) "emacspeak-moz" "\
Send expression to Moz, get output, and browse it in Emacs.

\(fn EXP)" t nil)

(autoload (quote emacspeak-moz-close-tab-or-browser) "emacspeak-moz" "\
Close tab, or browser when one tab left.

\(fn)" t nil)

(autoload (quote emacspeak-moz-goto-url) "emacspeak-moz" "\
Make Firefox used by our repl Go to the specified URL.

\(fn URL)" t nil)

(autoload (quote emacspeak-moz-goto-url-at-point) "emacspeak-moz" "\
Make Firefox used by our repl Go to url under point.

\(fn)" t nil)

(autoload (quote emacspeak-moz-browser-forward) "emacspeak-moz" "\
Move forward in history.

\(fn)" t nil)

(autoload (quote emacspeak-moz-browser-back) "emacspeak-moz" "\
Move back in history.

\(fn)" t nil)

(autoload (quote emacspeak-moz-jump) "emacspeak-moz" "\
Jump to specified index in history.

\(fn INDEX)" t nil)

(autoload (quote emacspeak-moz-inspect) "emacspeak-moz" "\
Inspect specified object.

\(fn WHAT)" t nil)

(autoload (quote emacspeak-moz-search) "emacspeak-moz" "\
Search for pattern in current context.

\(fn PATTERN)" t nil)

(autoload (quote emacspeak-moz-refresh) "emacspeak-moz" "\
Reload document.

\(fn)" t nil)

(autoload (quote emacspeak-moz-visit-next-and-browse) "emacspeak-moz" "\
Asks visitor to go  forward and browses the result.

\(fn)" t nil)

(autoload (quote emacspeak-moz-up) "emacspeak-moz" "\
Go Up a level and browse.

\(fn)" t nil)

(autoload (quote emacspeak-moz-down) "emacspeak-moz" "\
Go Down a level and browse.

\(fn)" t nil)

(autoload (quote emacspeak-moz-left) "emacspeak-moz" "\
Go left and browse.

\(fn)" t nil)

(autoload (quote emacspeak-moz-right) "emacspeak-moz" "\
Go right and browse.

\(fn)" t nil)

(autoload (quote emacspeak-moz-filter-and-browse) "emacspeak-moz" "\
Browse document filtered by XPath filter.

\(fn XPATH)" t nil)

(autoload (quote emacspeak-moz-id-browse) "emacspeak-moz" "\
Browse node having specified id.

\(fn ID)" t nil)

(autoload (quote emacspeak-moz-locate-and-browse) "emacspeak-moz" "\
Browse document filtered by element locator.

\(fn ELEMENT)" t nil)

(autoload (quote emacspeak-moz-browse-current) "emacspeak-moz" "\
Browse current node.

\(fn)" t nil)

(autoload (quote emacspeak-moz-visit-previous-and-browse) "emacspeak-moz" "\
...
;;;;;;  "emacspeak-personality" "emacspeak-personality.el" (19011
;;;;;;  5631))
...
(autoload (quote emacspeak-piglets-tts-init) "emacspeak-piglets" "\
Start TTS  engine for Piglets.

\(fn)" t nil)

(autoload (quote emacspeak-piglets-tab) "emacspeak-piglets" "\
Send TAB to Firefox.

\(fn)" t nil)

(autoload (quote emacspeak-piglets-enter) "emacspeak-piglets" "\
Send enter to Firefox.

\(fn)" t nil)

(autoload (quote emacspeak-piglets-keypress) "emacspeak-piglets" "\
Send keypress to Firefox.

\(fn C)" t nil)

(autoload (quote emacspeak-piglets-key) "emacspeak-piglets" "\
Send last keypress to Firefox.

\(fn)" t nil)

(autoload (quote emacspeak-piglets-silence) "emacspeak-piglets" "\
...
;;;;;;  "emacspeak-pronounce" "emacspeak-pronounce.el" (19011 5631))
...
(custom-autoload (quote emacspeak-realaudio-mp3-clipper) "emacspeak-realaudio" t)
...
;;;***

;;;### (autoloads (emacspeak-forward-char emacspeak-self-insert-command)
;;;;;;  "emacspeak-redefine" "emacspeak-redefine.el" (19011 5631))
;;; Generated autoloads from emacspeak-redefine.el

(autoload (quote emacspeak-self-insert-command) "emacspeak-redefine" "\
Insert a character.
...
(autoload (quote emacspeak-forward-char) "emacspeak-redefine" "\
...
(let ((loads (get (quote emacspeak-remote) (quote custom-loads)))) (if (member (quote "emacspeak-remote") loads) nil (put (quote emacspeak-remote) (quote custom-loads) (cons (quote "emacspeak-remote") loads))))

(autoload (quote emacspeak-remote-edit-current-remote-hostname) "emacspeak-remote" "\
...
(custom-autoload (quote emacspeak-remote-use-ssh) "emacspeak-remote" t)
...
(autoload (quote emacspeak-remote-home) "emacspeak-remote" "\
...
;;;***

;;;### (autoloads nil "emacspeak-setup" "emacspeak-setup.el" (19011
;;;;;;  5631))
...
(defconst emacspeak-version (eval-when-compile (format "30.0 %s" (cond ((file-exists-p emacspeak-readme-file) (let ((buffer (find-file-noselect emacspeak-readme-file)) (revision nil)) (save-excursion (set-buffer buffer) (goto-char (point-min)) (setq revision (format "Revision %s" (or (nth 2 (split-string (buffer-substring-no-properties (line-beginning-position) (line-end-position)))) "unknown")))) (kill-buffer buffer) revision)) (t "")))) "\
Version number for Emacspeak.")

(defconst emacspeak-codename "SocialDog" "\
...
;;;;;;  "emacspeak-sounds.el" (19011 5631))
;;; Generated autoloads from emacspeak-sounds.el

(autoload (quote emacspeak-audio-setup) "emacspeak-sounds" "\
...
(custom-autoload (quote emacspeak-sounds-default-theme) "emacspeak-sounds" t)
...
(custom-autoload (quote emacspeak-play-program) "emacspeak-sounds" t)
...
;;;;;;  "emacspeak-speak" "emacspeak-speak.el" (19011 5631))
...
(custom-autoload (quote emacspeak-speak-embedded-url-pattern) "emacspeak-speak" t)
...
(custom-autoload (quote emacspeak-line-echo) "emacspeak-speak" t)
...
(custom-autoload (quote emacspeak-word-echo) "emacspeak-speak" t)
...
(custom-autoload (quote emacspeak-character-echo) "emacspeak-speak" t)
                         ;
...
(autoload (quote emacspeak-get-current-completion) "emacspeak-speak" "\
...
(custom-autoload (quote emacspeak-use-header-line) "emacspeak-speak" t)

(autoload (quote emacspeak-toggle-header-line) "emacspeak-speak" "\
...
(autoload (quote emacspeak-speak-this-face-chunk) "emacspeak-speak" "\
Speak chunk of text around point that has current face.

\(fn)" t nil)

(autoload (quote emacspeak-speak-next-face-chunk) "emacspeak-speak" "\
Moves to the front of next chunk having current face.
Speak that chunk after moving.

\(fn)" t nil)

(autoload (quote emacspeak-speak-previous-face-chunk) "emacspeak-speak" "\
...
(autoload (quote emacspeak-completion-pick-completion) "emacspeak-speak" "\
...
(autoload (quote emacspeak-switch-to-reference-buffer) "emacspeak-speak" "\
...
(defalias (quote emacspeak-mark-forward-mark) (quote pop-to-mark-command))
...
;;;;;;  "emacspeak-tabulate" "emacspeak-tabulate.el" (19011 5631))
...
;;;;;;  "emacspeak-tapestry" "emacspeak-tapestry.el" (19011 5631))
...
;;;;;;  "emacspeak-url-template" "emacspeak-url-template.el" (19011
;;;;;;  5631))
...
(custom-autoload (quote emacspeak-url-template-weather-city-state) "emacspeak-url-template" t)
...
(defalias (quote make-dtk-speech-style) (quote make-acss))

;;;***

;;;### (autoloads (emacspeak-w3m-preview-this-buffer) "emacspeak-w3m"
;;;;;;  "emacspeak-w3m.el" (19011 5631))
...
;;;;;;  "emacspeak-we" "emacspeak-we.el" (19011 5631))
;;; Generated autoloads from emacspeak-we.el

(autoload (quote emacspeak-we-url-rewrite-and-follow) "emacspeak-we" "\
...
(custom-autoload (quote emacspeak-we-xsl-p) "emacspeak-we" t)

(defvar emacspeak-we-xsl-transform nil "\
Specifies transform to use before displaying a page.
Nil means no transform is used. ")

(custom-autoload (quote emacspeak-we-xsl-transform) "emacspeak-we" t)
...
(custom-autoload (quote emacspeak-we-cleanup-bogus-quotes) "emacspeak-we" t)

(autoload (quote emacspeak-we-xslt-apply) "emacspeak-we" "\
Apply specified transformation to current Web page.

\(fn XSL)" t nil)

(autoload (quote emacspeak-we-xslt-select) "emacspeak-we" "\
Select XSL transformation applied to Web pages before they are displayed .

\(fn XSL)" t nil)

(autoload (quote emacspeak-we-xsl-toggle) "emacspeak-we" "\
Toggle  application of XSL transformations.

\(fn)" t nil)

(autoload (quote emacspeak-we-count-matches) "emacspeak-we" "\
Count matches for locator  in Web page.

\(fn URL LOCATOR)" t nil)

(autoload (quote emacspeak-we-count-nested-tables) "emacspeak-we" "\
Count nested tables in Web page.

\(fn URL)" t nil)

(autoload (quote emacspeak-we-count-tables) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-toggle-xsl-keep-result) "emacspeak-we" "\
Toggle xsl keep result flag.

\(fn)" t nil)

(autoload (quote emacspeak-we-xslt-filter) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-xslt-junk) "emacspeak-we" "\
Junk elements matching specified locator.

\(fn PATH URL &optional SPEAK)" t nil)

(autoload (quote emacspeak-we-extract-media-streams) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-print-streams) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-media-streams-under-point) "emacspeak-we" "\
In browser buffers, extract media streams from url under point.

\(fn)" t nil)

(autoload (quote emacspeak-we-extract-matching-urls) "emacspeak-we" "\
Extracts links whose URL matches pattern.

\(fn PATTERN URL &optional SPEAK)" t nil)

(autoload (quote emacspeak-we-extract-nested-table) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-nested-table-list) "emacspeak-we" "\
Extract specified list of tables from a Web page.

\(fn TABLES URL &optional SPEAK)" t nil)

(autoload (quote emacspeak-we-extract-table-by-position) "emacspeak-we" "\
Extract table at specified position.
Default is to extract from current page.

\(fn POSITION URL &optional SPEAK)" t nil)

(autoload (quote emacspeak-we-extract-tables-by-position-list) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-table-by-match) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-tables-by-match-list) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-by-class) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-by-class-list) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-by-id) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-by-id-list) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-junk-by-class-list) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-class-filter-and-follow) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-follow-and-filter-by-id) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-style-filter) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-xpath-filter-and-follow) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-xpath-junk-and-follow) "emacspeak-we" "\
...
(autoload (quote emacspeak-we-extract-by-property) "emacspeak-we" "\
...
;;;;;;  "emacspeak-webmarks.el" (19011 5631))
;;; Generated autoloads from emacspeak-webmarks.el

(autoload (quote emacspeak-webmarks-list) "emacspeak-webmarks" "\
List WebMarks.

\(fn)" t nil)

(autoload (quote emacspeak-webmarks-search) "emacspeak-webmarks" "\
Search WebMarks.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-webmarks-history) "emacspeak-webmarks" "\
Search search history.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-webmarks-add) "emacspeak-webmarks" "\
Add WebMark.
...
;;;;;;  "emacspeak-websearch.el" (19011 5631))
;;; Generated autoloads from emacspeak-websearch.el

(let ((loads (get (quote emacspeak-websearch) (quote custom-loads)))) (if (member (quote "emacspeak-websearch") loads) nil (put (quote emacspeak-websearch) (quote custom-loads) (cons (quote "emacspeak-websearch") loads))))

(autoload (quote emacspeak-websearch-help) "emacspeak-websearch" "\
...
(autoload (quote emacspeak-websearch-alltheweb-search) "emacspeak-websearch" "\
Perform an AllTheWeb  search.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-altavista-search) "emacspeak-websearch" "\
Perform an Altavista search

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-biblio-search) "emacspeak-websearch" "\
Search Computer Science Bibliographies.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-citeseer-search) "emacspeak-websearch" "\
Perform a CiteSeer search. 

\(fn TERM)" t nil)

(autoload (quote emacspeak-websearch-bbc-search) "emacspeak-websearch" "\
Search BBC archives.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-blinkx-search) "emacspeak-websearch" "\
BlinkX RSS Generator.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-podzinger-search) "emacspeak-websearch" "\
Podzinger RSS Generator.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-foldoc-search) "emacspeak-websearch" "\
Perform a FolDoc search. 

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-quotes-yahoo-search) "emacspeak-websearch" "\
...
(autoload (quote emacspeak-websearch-company-news) "emacspeak-websearch" "\
...
(autoload (quote emacspeak-websearch-yahoo-historical-chart) "emacspeak-websearch" "\
...
(autoload (quote emacspeak-websearch-dictionary-hypertext-webster-search) "emacspeak-websearch" "\
Search the Webster Dictionary.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-sourceforge-search) "emacspeak-websearch" "\
Search SourceForge Site. 

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-freshmeat-search) "emacspeak-websearch" "\
Search Freshmeat  Site. 

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-ctan-search) "emacspeak-websearch" "\
Search CTAN Comprehensive TeX Archive Network   Site. 

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-cpan-search) "emacspeak-websearch" "\
Search CPAN  Comprehensive Perl Archive Network   Site. 

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-swik-search) "emacspeak-websearch" "\
Search swik software community site.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-software-search) "emacspeak-websearch" "\
Search SourceForge, Freshmeat and other sites. 

\(fn)" t nil)

(autoload (quote emacspeak-websearch-britannica-search) "emacspeak-websearch" "\
Search Encyclopedia Britannica.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-gutenberg) "emacspeak-websearch" "\
...
(custom-autoload (quote emacspeak-websearch-google-number-of-results) "emacspeak-websearch" t)
...
(autoload (quote emacspeak-websearch-accessible-google) "emacspeak-websearch" "\
Google Accessible Search -- see http://labs.google.com/accessible

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-google-feeling-lucky) "emacspeak-websearch" "\
Do a I'm Feeling Lucky Google search.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-google-specialize) "emacspeak-websearch" "\
...
(autoload (quote emacspeak-websearch-froogle) "emacspeak-websearch" "\
...
(autoload (quote emacspeak-websearch-google-sak) "emacspeak-websearch" "\
Perform a Google query against a specific index.

\(fn ENGINE QUERY)" t nil)

(autoload (quote emacspeak-websearch-technorati) "emacspeak-websearch" "\
Perform a Technorati tag search.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-teoma) "emacspeak-websearch" "\
Perform an Teoma  search.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-google-advanced) "emacspeak-websearch" "\
Present Google advanced search form simplified for speech interaction.

\(fn)" t nil)

(autoload (quote emacspeak-websearch-google-mobile) "emacspeak-websearch" "\
Google mobile search.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-google-news) "emacspeak-websearch" "\
...
(autoload (quote emacspeak-websearch-emaps-search) "emacspeak-websearch" "\
...
(autoload (quote emacspeak-websearch-google-usenet-advanced) "emacspeak-websearch" "\
Present Google Usenet advanced search form simplified for speech interaction.

\(fn)" t nil)

(autoload (quote emacspeak-websearch-ask-jeeves) "emacspeak-websearch" "\
Ask Jeeves for the answer.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-map-yahoo-directions-search) "emacspeak-websearch" "\
...
(autoload (quote emacspeak-websearch-news-yahoo) "emacspeak-websearch" "\
Perform an Yahoo News search.
Optional prefix arg no-rss scrapes information from HTML.

\(fn QUERY &optional NO-RSS)" t nil)

(autoload (quote emacspeak-websearch-open-directory-search) "emacspeak-websearch" "\
Perform an Open Directory search

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-rpm-find) "emacspeak-websearch" "\
Search RPM  catalog  site.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-recorded-books-search) "emacspeak-websearch" "\
Present advanced search form for recorded books.

\(fn)" t nil)

(autoload (quote emacspeak-websearch-merriam-webster-search) "emacspeak-websearch" "\
Search the Merriam Webster Dictionary.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-weather) "emacspeak-websearch" "\
Get weather forecast for specified zip code.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-w3c-search) "emacspeak-websearch" "\
Search the W3C Site.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-wikipedia-search) "emacspeak-websearch" "\
Search Wikipedia

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-people-yahoo) "emacspeak-websearch" "\
Perform an Yahoo  people search

\(fn)" t nil)

(autoload (quote emacspeak-websearch-podscope) "emacspeak-websearch" "\
Perform a PodScope search to locate podcasts.

\(fn)" t nil)

(autoload (quote emacspeak-websearch-yahoo) "emacspeak-websearch" "\
Perform an Yahoo  search

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-exchange-rate-convertor) "emacspeak-websearch" "\
Currency convertor.

\(fn CONVERSION-SPEC)" t nil)

(autoload (quote emacspeak-websearch-yahoo-exchange-rate-convertor) "emacspeak-websearch" "\
Currency convertor.

\(fn CONVERSION-SPEC)" t nil)

(autoload (quote emacspeak-websearch-my-rss-search) "emacspeak-websearch" "\
My RSS search.

\(fn QUERY)" t nil)

(autoload (quote emacspeak-websearch-amazon-search) "emacspeak-websearch" "\
Amazon search.

\(fn)" t nil)

(autoload (quote emacspeak-websearch-ebay-search) "emacspeak-websearch" "\
Ebay search.

\(fn)" t nil)

(autoload (quote emacspeak-websearch-shoutcast-search) "emacspeak-websearch" "\
Shoutcast search.
...
(autoload (quote emacspeak-webspace-transcode) "emacspeak-webspace" "\
Transcode headline at point by following its link property.

\(fn)" t nil)

(autoload (quote emacspeak-webspace-yank-link) "emacspeak-webspace" "\
Yank link under point into kill ring.

\(fn)" t nil)

(autoload (quote emacspeak-webspace-open) "emacspeak-webspace" "\
Open headline at point by following its link property.

\(fn)" t nil)

(autoload (quote emacspeak-webspace-filter) "emacspeak-webspace" "\
Open headline at point by following its link property and filter for content.

\(fn)" t nil)

(autoload (quote emacspeak-webspace-next-link) "emacspeak-webspace" "\
Move to next link.

\(fn)" t nil)

(autoload (quote emacspeak-webspace-previous-link) "emacspeak-webspace" "\
Move to previous link.

\(fn)" t nil)

(autoload (quote emacspeak-webspace-headlines-view) "emacspeak-webspace" "\
Display all cached headlines in a special interaction buffer.

\(fn)" t nil)

(define-prefix-command (quote emacspeak-webspace) (quote emacspeak-webspace-keymap))

(autoload (quote emacspeak-webspace-headlines) "emacspeak-webspace" "\
Speak current news headline.

\(fn)" t nil)

(autoload (quote emacspeak-webspace-weather) "emacspeak-webspace" "\
Speak current weather.

\(fn)" t nil)

(autoload (quote emacspeak-webspace-reader-unsubscribe) "emacspeak-webspace" "\
Unsubscribe to link under point.

\(fn)" t nil)

(autoload (quote emacspeak-webspace-google) "emacspeak-webspace" "\
...
;;;;;;  "emacspeak-webutils" "emacspeak-webutils.el" (19011 5631))
...
(defvar emacspeak-webutils-charent-alist (quote (("&lt;" . "<") ("&gt;" . ">") ("&quot;" . "\"") ("&apos;" . "'") ("&amp;" . "&"))) "\
Entities to unescape when treating badly escaped XML.")

(custom-autoload (quote emacspeak-webutils-charent-alist) "emacspeak-webutils" t)

(autoload (quote emacspeak-webutils-post-process) "emacspeak-webutils" "\
...
(autoload (quote emacspeak-webutils-google-who-links-to-this-page) "emacspeak-webutils" "\
Perform a google search to locate documents that link to the
current page.

\(fn)" t nil)

(autoload (quote emacspeak-webutils-google-extract-from-cache) "emacspeak-webutils" "\
Extract current  page from the Google cache.
With a prefix argument, extracts url under point.

\(fn &optional PREFIX)" t nil)

(autoload (quote emacspeak-webutils-google-on-this-site) "emacspeak-webutils" "\
Perform a google search restricted to the current WWW site.

\(fn)" t nil)

(autoload (quote emacspeak-webutils-google-similar-to-this-page) "emacspeak-webutils" "\
...
(autoload (quote emacspeak-webutils-transcode-via-google) "emacspeak-webutils" "\
...
(autoload (quote emacspeak-webutils-transcode-current-url-via-google) "emacspeak-webutils" "\
Transcode current URL via Google.
  Reverse effect with prefix arg.

\(fn &optional UNTRANSCODE)" t nil)

(autoload (quote emacspeak-webutils-jump-to-title-in-content) "emacspeak-webutils" "\
...
(autoload (quote emacspeak-webutils-play-media-at-point) "emacspeak-webutils" "\
Play media url under point 

\(fn)" t nil)

(autoload (quote emacspeak-webutils-view-feed-via-google-reader) "emacspeak-webutils" "\
Pulls feed under point via Google Reader.

\(fn)" t nil)

(autoload (quote emacspeak-webutils-open-in-other-browser) "emacspeak-webutils" "\
Opens link in alternate browser.
 If using default browser is w3, uses w3m and vice-versa

\(fn)" t nil)

(autoload (quote emacspeak-webutils-rss-display) "emacspeak-webutils" "\
Display RSS feed.

\(fn FEED-URL)" t nil)

(autoload (quote emacspeak-webutils-atom-display) "emacspeak-webutils" "\
Display ATOM feed.

\(fn FEED-URL)" t nil)

(autoload (quote emacspeak-webutils-fv) "emacspeak-webutils" "\
Display RSS or ATOM feed URL.

\(fn FEED-URL)" t nil)

(let ((loads (get (quote emacspeak-rss) (quote custom-loads)))) (if (member (quote "emacspeak-webutils") loads) nil (put (quote emacspeak-rss) (quote custom-loads) (cons (quote "emacspeak-webutils") loads))))

(autoload (quote emacspeak-opml-display) "emacspeak-webutils" "\
Retrieve and display OPML  URL.

\(fn OPML-URL &optional SPEAK)" t nil)

(autoload (quote emacspeak-rss-browse) "emacspeak-webutils" "\
Browse specified RSS feed.

\(fn FEED)" t nil)

(let ((loads (get (quote emacspeak-atom) (quote custom-loads)))) (if (member (quote "emacspeak-webutils") loads) nil (put (quote emacspeak-atom) (quote custom-loads) (cons (quote "emacspeak-webutils") loads))))

(defvar emacspeak-atom-feeds nil "\
Table of ATOM feeds.")

(custom-autoload (quote emacspeak-atom-feeds) "emacspeak-webutils" t)

(autoload (quote emacspeak-atom-browse) "emacspeak-webutils" "\
...
;;;***

;;;### (autoloads (emacspeak-wizards-previous-bullet emacspeak-wizards-next-bullet
;;;;;;  emacspeak-wizards-find-emacspeak-source emacspeak-wizards-popup-input-buffer
...
(autoload (quote emacspeak-wizards-byte-compile-current-buffer) "emacspeak-wizards" "\
byte compile current buffer

\(fn)" t nil)

(autoload (quote emacspeak-wizards-load-current-file) "emacspeak-wizards" "\
load file into emacs

\(fn)" t nil)

(autoload (quote emacspeak-wizards-end-of-word) "emacspeak-wizards" "\
move to end of word

\(fn ARG)" t nil)

(autoload (quote emacspeak-wizards-comma-at-end-of-word) "emacspeak-wizards" "\
Move to the end of current word and add a comma.

\(fn)" t nil)

(autoload (quote emacspeak-wizards-lacheck-buffer-file) "emacspeak-wizards" "\
Run Lacheck on current buffer.

\(fn)" t nil)

(autoload (quote emacspeak-wizards-tex-tie-current-word) "emacspeak-wizards" "\
...
(autoload (quote emacspeak-wizards-i810-display-status) "emacspeak-wizards" "\
...
(autoload (quote emacspeak-wizards-show-eval-result) "emacspeak-wizards" "\
Convenience command to pretty-print and view Lisp evaluation results.

\(fn FORM)" t nil)

(autoload (quote emacspeak-wizards-show-memory-used) "emacspeak-wizards" "\
...
(autoload (quote emacspeak-wizards-pdf-open) "emacspeak-wizards" "\
...
(autoload (quote emacspeak-wizards-display-pod-as-manpage) "emacspeak-wizards" "\
...
(autoload (quote emacspeak-wizards-js) "emacspeak-wizards" "\
...
(autoload (quote emacspeak-wizards-refresh-shell-history) "emacspeak-wizards" "\
...
(autoload (quote emacspeak-wizards-shell-bind-keys) "emacspeak-wizards" "\
...
(autoload (quote emacspeak-wizards-thanks-mail-signature) "emacspeak-wizards" "\
...
(autoload (quote emacspeak-wizards-next-bullet) "emacspeak-wizards" "\
Navigate to and speak next `bullet'.

\(fn)" t nil)

(autoload (quote emacspeak-wizards-previous-bullet) "emacspeak-wizards" "\
...
;;;;;;  "emacspeak-xml-shell.el" (19011 5631))
;;; Generated autoloads from emacspeak-xml-shell.el

(let ((loads (get (quote emacspeak-xml-shell) (quote custom-loads)))) (if (member (quote "emacspeak-xml-shell") loads) nil (put (quote emacspeak-xml-shell) (quote custom-loads) (cons (quote "emacspeak-xml-shell") loads))))
...
(custom-autoload (quote emacspeak-xslt-options) "emacspeak-xslt" t)
...
(custom-autoload (quote emacspeak-xslt-use-wget-to-download) "emacspeak-xslt" t)
...
(autoload (quote emacspeak-xslt-view) "emacspeak-xslt" "\
Browse URL with specified XSL style.

\(fn STYLE URL)" t nil)

(autoload (quote emacspeak-xslt-view-xml) "emacspeak-xslt" "\
Browse XML URL with specified XSL style.

\(fn STYLE URL &optional UNESCAPE-CHARENT)" t nil)

(autoload (quote emacspeak-xslt-view-region) "emacspeak-xslt" "\
...
(define-prefix-command (quote emacspeak-zinf-prefix-command) (quote emacspeak-zinf-mode-map))

(autoload (quote emacspeak-zinf-zinf-command) "emacspeak-zinf" "\
Execute Zinf command.

\(fn CHAR)" t nil)

(autoload (quote emacspeak-zinf-zinf-call-command) "emacspeak-zinf" "\
Call appropriate zinf command.

\(fn)" t nil)

(autoload (quote emacspeak-zinf) "emacspeak-zinf" "\
...
;;;***

;;;### (autoloads (tts-eflite) "flite-voices" "flite-voices.el" (19011
;;;;;;  5631))
...
;;;;;;  voice-lock-mode) "voice-setup" "voice-setup.el" (19011 5631))
...
;;;;;;  "emacspeak-amark.el" "emacspeak-analog.el" "emacspeak-ansi-color.el"
;;;;;;  "emacspeak-apt-sources.el" "emacspeak-apt-utils.el" "emacspeak-arc.el"
;;;;;;  "emacspeak-auctex.el" "emacspeak-autoload.el" "emacspeak-babel.el"
;;;;;;  "emacspeak-bbdb.el" "emacspeak-bibtex.el" "emacspeak-bmk-mgr.el"
;;;;;;  "emacspeak-bookmark.el" "emacspeak-browse-kill-ring.el" "emacspeak-bs.el"
;;;;;;  "emacspeak-buff-menu.el" "emacspeak-c.el" "emacspeak-calc.el"
;;;;;;  "emacspeak-calculator.el" "emacspeak-cedet.el" "emacspeak-checkdoc.el"
;;;;;;  "emacspeak-cmuscheme.el" "emacspeak-compile.el" "emacspeak-cperl.el"
;;;;;;  "emacspeak-damlite.el" "emacspeak-desktop.el" "emacspeak-dictation.el"
;;;;;;  "emacspeak-dictionary.el" "emacspeak-dired.el" "emacspeak-dismal.el"
;;;;;;  "emacspeak-dmacro.el" "emacspeak-ecb.el" "emacspeak-ediary.el"
;;;;;;  "emacspeak-ediff.el" "emacspeak-emms.el" "emacspeak-enriched.el"
;;;;;;  "emacspeak-entertain.el" "emacspeak-eperiodic.el" "emacspeak-erc.el"
;;;;;;  "emacspeak-eshell.el" "emacspeak-ess.el" "emacspeak-etable.el"
;;;;;;  "emacspeak-eudc.el" "emacspeak-facemenu.el" "emacspeak-find-dired.el"
;;;;;;  "emacspeak-find-func.el" "emacspeak-finder.el" "emacspeak-flyspell.el"
;;;;;;  "emacspeak-folding.el" "emacspeak-generic.el" "emacspeak-gnuplot.el"
;;;;;;  "emacspeak-gnus.el" "emacspeak-gomoku.el" "emacspeak-gud.el"
;;;;;;  "emacspeak-hideshow.el" "emacspeak-ibuffer.el" "emacspeak-ido.el"
;;;;;;  "emacspeak-ispell.el" "emacspeak-iswitchb.el" "emacspeak-jabber.el"
;;;;;;  "emacspeak-jde.el" "emacspeak-js2.el" "emacspeak-kmacro.el"
...
;;;;;;  "emacspeak-mpg123.el" "emacspeak-mspools.el" "emacspeak-muse.el"
...
;;;;;;  "emacspeak-php-mode.el" "emacspeak-preamble.el" "emacspeak-proced.el"
;;;;;;  "emacspeak-psgml.el" "emacspeak-python.el" "emacspeak-re-builder.el"
...
;;;;;;  "emacspeak-todo-mode.el" "emacspeak-twit.el" "emacspeak-view-process.el"
;;;;;;  "emacspeak-view.el" "emacspeak-vm.el" "emacspeak-wdired.el"
;;;;;;  "emacspeak-windmove.el" "emacspeak-winring.el" "emacspeak-xslide.el"
;;;;;;  "emacspeak-xslt-process.el" "espeak-voices.el" "multispeech-voices.el"
;;;;;;  "outloud-voices.el" "russian-spelling.el" "stack-f.el" "tapestry.el")
;;;;;;  (19011 6115 171558))

;;;***

;;;### (autoloads (amixer) "amixer" "amixer.el" (19011 5631))
;;; Generated autoloads from amixer.el

(autoload (quote amixer) "amixer" "\
