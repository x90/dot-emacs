...
;;; $Id: yahtml-voice.el 4532 2007-05-04 01:13:44Z tv.raman.tv $
;;; $Author: tv.raman.tv $ 
...
(defadvice yahtml-goto-corresponding-* (after emacspeak pre act)
  "speak the move matching html tag"
...
(defadvice YaTeX-kill-buffer (after emacspeak pre act)
  "anounce kill current buffer"
